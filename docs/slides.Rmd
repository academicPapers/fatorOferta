...
--
  ...
  consagrado 0,9 (desconto de 10% sobre o preço original pedido). Todos os
  demais fatores devem ser considerados após a aplicação do fator oferta.
  
--

  - 10.6 - 1. A utilização dos fatores deve ser na forma de somatório, **após a 
...
* **A amostra é desbalanceada: os dados de oferta possuem áreas maiores**.
