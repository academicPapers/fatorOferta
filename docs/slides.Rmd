...
value has emerged `r AutoCite(bib, 'mooya2009')`.
...
* `r AutoCite(bib, 'erba2019', after = 'p.40')`: En el área catastral es 
justamente la georreferenciación que permite estructurar bases de datos con la 
ubicación, forma y dimensiones de cada parcela, dándole continuidad a la 
...
* `r Citet(bib, "haurin")` mostram que, em períodos de *boom*, no MI os preços de
...
*i.e.* a partir de modelos de regressão linear, tanto para a forma aditiva como 
para a forma multiplicativa de utilização dos fatores.
